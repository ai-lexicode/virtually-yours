...
modified: 2026-04-03T14:00
implemented: 2026-04-03T14:00
priority: high
size: medium
created: 2026-04-03
...
- [x] All 10 emails use React Email components with shared layout
- [x] Logo visible in email header
- [x] Gold brand colors (`#c89c6f` / `#d4a853`) used consistently
- [x] Gradient buttons match app styling
- [x] Footer includes KvK, BTW, phone, website link
- [x] No inline HTML strings remain for email content
- [x] Existing email functionality unchanged (same recipients, subjects, content)
